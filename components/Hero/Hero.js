...
function Hero({ pageInfo }) {
  ...
  return (
    <div className="absolute h-screen w-full mx-auto top-0">
      <div className="w-[100vw] h-[100vh] absolute z-7 right-0 bottom-0">
        <div className="bg-none md:bg-explosion md:bg-cover md:bg-right md:bg-no-repeat w-full h-full absolute mix-bleed-color-dodge translate-z-0"></div>
        <ParticlesContainer />
        <motion.div
